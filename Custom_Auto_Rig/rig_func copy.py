        ...
        for item in shape_key_names:
            ...
            for key in bone_drivers.keys():
                ...
                if key.lower() in item.lower():
                    ...
                    if bone_drivers[key][0] == None:
                        pass
                    elif "!!" in item:
                        pass
                    elif 'head' in item:
                        name_of_driving_bone = 'head'
                        driving_bones[item] = [name_of_driving_bone, bone_drivers[key][1]] ## when adding to dictionary, have name_of_driving_bone be the first item on list, and number second [name_of_driving, num]
