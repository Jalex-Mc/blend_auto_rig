...
if "script-3.py" not in bpy.data.texts:
    text_block = bpy.data.texts.new("script-3.py")
else:
    text_block = bpy.data.texts["script-3.py"]


with open('O:/Onedrive/Python_Blender/blend_auto_rig/Custom_Auto_Rig/Auto_rig_3 blend.py') as file:
    lines = file.read()
    # lines = [line.rstrip('\n') for line in file]
    # for line in file:
    #     print(line.rstrip())
